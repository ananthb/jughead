import {
  getDiagramElement,
  setupViewPortForSVG
} from "./chunk-X3WOKQ54.mjs";
import {
  JSON_SCHEMA,
  load
} from "./chunk-7LFHKSNR.mjs";
import {
  getRegisteredLayoutAlgorithm,
  render
} from "./chunk-JPW5SGIG.mjs";
import "./chunk-FMFP6ZX4.mjs";
import {
  isValidShape
} from "./chunk-INBA35WA.mjs";
...
var addVertex = /* @__PURE__ */ __name(function(id, textObj, type, style, classes2, dir, props = {}, metadata) {
...
var addSingleLink = /* @__PURE__ */ __name(function(_start, _end, type, id) {
  const start = _start;
  const end = _end;
  const edge = {
    start,
...
__name(isLinkData, "isLinkData");
var addLink = /* @__PURE__ */ __name(function(_start, _end, linkData) {
  const id = isLinkData(linkData) ? linkData.id.replace("@", "") : void 0;
...
var addClass = /* @__PURE__ */ __name(function(ids, _style) {
